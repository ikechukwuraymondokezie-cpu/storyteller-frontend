    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 h-16 bg-black border-t border-gray-800 z-50">
            <div className="flex justify-around items-center h-full">
                ...
                {/* Upload button – square and full navbar height */}
                <button
                    className="w-16 h-full bg-gradient-to-r from-red-500 via-orange-400 to-yellow-300 
                     flex items-center justify-center text-white text-xl rounded-none 
